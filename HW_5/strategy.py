...
class BestPosStrategy:
    ...
    def __init__(self, delay: float, risk_koef, hold_time:Optional[float] = None) -> None:
        ...
        # sorry
        df = pd.read_csv('C:\\Users\\artem\\.Computer Science\\CMF\\Projects_HFMM\data\md\\btcusdt_Binance_LinearPerpetual\lobs.csv')
    ...
    def run(self, sim: Sim ) ->\
        ...
        while True:
            ...
            if receive_ts - prev_time >= self.delay:
                ...
                indifference_price = self.next_price_dict[receive_ts]  # (T - t) = 1
